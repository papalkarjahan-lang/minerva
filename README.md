...
supabase secrets set APP_URL=https://minerva-green.vercel.app
...
├── supabase_schema_delta_subcontractor_pool_addon.sql # server-enforce subcontractor_pool addon (2026-09-05)
